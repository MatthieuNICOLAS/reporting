...
- MUTE : Implémenter le mécanisme de renommage
  ...
  - Finalement, il s'agit d'un cas particulier de OT
	...
	- On recherche le contexte ancêtre à la fois de /op1/ et de /op2/
    ...
    - Là encore, on va utiliser la /renamingMap/ qui a servi à passer du contexte ancêtre au contexte de /op1/ pour la transformée arrière

...
- Meeting
  - Regarding my work on RenamableLogootSplit
    ...
    - Actually, i haven't been able to find a way to update the renaming functions to deal with the problematic identifiers.
    - So i changed the function used to pick ids to prevent the generation of problematic ids
* Backlog

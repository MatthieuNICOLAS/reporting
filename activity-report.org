...
*** Planned
**** IN-PROGRESS Planifier le cours de BDD pour la rentrée
...
**** TODO Faire un schéma d'un exemple pour illustrer /reverseRenameId()/
...
- Planifier le cours de BDD pour la rentrée
  - Support 1
	...
	- Types de SGBDs (relationnels, colonnes, documents, graphes)
	- Tour d'horizon des SGBDs relationnelles
    - Estimation
      - 30min
* Backlog

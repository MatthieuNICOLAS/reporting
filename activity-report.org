...
**** TODO PHD DAY : Rédiger un abstract sur le sujet de thèse
...
- Dans le cadre du PhD Day, je dois effectuer une présentation de 5min
  - Emphasize on what is your research problem, who else are working on the same/similar problem, what is your specific approach, and what is/are your expected results
**** TODO ADMINISTRATIF : Remplir le formulaire *Charges d’enseignement pour Doctorant contractuel*
**** TODO CONSENSUS : Lire *The part-time parliament*
...
**** TODO DISTRIBUTED SYSTEMS : Lire *Spanner: Google’s Globally Distributed Database*

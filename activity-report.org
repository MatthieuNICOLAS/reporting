...
- TVPaint : Étudier comment interagir avec BonitaSoft par API
  - S'authentifier
    - http://localhost:8728/bonita/loginservice
    - Paramètres:
      - /username/
      - /password/
    ...
    - Exemple:
      - http://localhost:8728/bonita/loginservice?username=walter.bates&password=1234&redirect=true
  - Récupérer l'identifiant de l'utilisateur
    - http://localhost:8728/bonita/API/identity/user
    - Paramètres
      - /f/: le champ avec lequel on souhaite filtrer
    - Exemple:
      - http://localhost:8728/bonita/API/identity/user?f=userName=walter.bates
    - Réponse:
      #+BEGIN_SRC
[
  {
  ...
  - Récupérer les tâches assignées à l'utilisateur
    - http://localhost:8728/bonita/API/bpm/humanTask
    - Paramètres:
      - /f/: le champ avec lequel on souhaite filtrer
    - Exemple:
      - http://localhost:8728/bonita/API/bpm/humanTask?f=assigned_id=4
    - Réponse:
      #+BEGIN_SRC
[
  {
...
**** TODO MUTE : Ajouter la gestion des documents stockées en local
...
**** TODO MUTE : Ajouter le mécanisme de join propre

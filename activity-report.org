...
- <<dottedb>> DISTRUBUTED SYSTEMS : Lire *DottedDB: Anti-Entropy without Merkle Trees, Deletes without Tombstones*
...
*** Planned
**** IN-PROGRESS DISTRIBUTED SYSTEMS : Lire *Perspectives on the CAP Theorem*
- Disponible ici : https://groups.csail.mit.edu/tds/papers/Gilbert/Brewer2.pdf
**** IN-PROGRESS DISTRIBUTED SYSTEMS : Lire *DottedDB: Anti-Entropy without Merkle Trees, Deletes without Tombstones*
...
**** TODO DISTRIBUTED SYSTEMS: Lire *Dynamo: amazon’s highly available key-value store*

...
- CRDT : Idée pour le renommage
  ...
  - Problème
    - Si chacun se contente uniquement de rejouer ses opérations, on peut perdre au cours du renommage des opérations
      - Potentiellement, un utilisateur ne va jamais se reconnecter et donc jamais rejouer ses opérations
    - Si chacun rejoue les opérations de tous les utilisateurs, on risque de dupliquer l'intention
      - Si plusieurs utilisateurs ont observé la même opération concurrente à l'opération de renommage, ils vont chacun la ré-appliquer
  - Idée
...
**** TODO PHD DAY : Préparer une présentation sur le sujet de thèse
     SCHEDULED: <2017-12-07 Thu>
- Dans le cadre du PhD Day, je dois effectuer une présentation de 5min
  - Emphasize on what is your research problem, who else are working on the same/similar problem, what is your specific approach, and what is/are your expected results
**** TODO DISTRIBUTED SYSTEMS : Lire *Beyond TrueTime:  Using AugmentedTime for Improving Spanner*
- Disponible ici : https://www.cse.buffalo.edu//~demirbas/publications/augmentedTime.pdf
...
**** TODO MUTE : Ajouter des tests pour *SyncService*

...
**** IN-PROGRESS MUTE : Organiser une session de test sur mute-structs@0.4.0
...
**** IN-PROGRESS MUTE : Supprimer la boucle de rafraîchissement infinie de Angular
...
**** TODO MUTE : Enrichir *SyncService* pour assurer une livraison causale

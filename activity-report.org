...
**** TODO Papier : Revamp algo de /renameId()/ dans la section *RLS in centralised settings*
...
- Meeting
  - Principalement bossé sur le papier
    ...
    - Là en train d'effectuer quelques modifs sur la section *Overview*
      - Histoire d'être un peu plus exhaustif et précis sur ce qu'est RenamableLogootSplit
      - Ajoute une nouvelle sous-section pour présenter les /safety properties/ que doit respecter l'opération /rename/

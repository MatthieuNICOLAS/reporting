...
- TVPaint : Implémenter le prototype orchestrant TVPaint server et Bonita
  ...
  - De nouveau, un choix de conception se pose
    - [ ] Faut-il contraindre avec /append()/ le type de la donnée ajoutée
      - /append(appendable: T1, appendee: T2)/
    - [ ] ou juste se contenter de manipuler des identifiants
...
**** TODO TVPaint : Mener une refléxion sur l'implémentation ou non d'un mécanisme de transaction

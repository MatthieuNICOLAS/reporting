...
- Voir si reproductible
**** TODO Publier la version corrigée de /mute-structs/
...
**** TODO Publier les scripts utilisés pour le debugging
...
**** TODO Mettre à jour /mute-bot-random/ avec la version corrigée de /mute-structs/
**** TODO Relancer des simus en local et vérifier leur validité
- Une dizaine d'échantillons permettra de vérifier si des bugs sont encore présents
**** TODO Mettre à jour l'environnement sur la machine /coast-srv0/
- Transférer la nouvelle image Docker
- Transférer les nouveaux /docker-compose/
**** TODO Programmer le lancement des simus

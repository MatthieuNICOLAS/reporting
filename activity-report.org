...
*** Planned
**** IN-PROGRESS Papier : Rédiger intro
**** TODO Papier : Rédiger sous-section sur stratégie de renommage
- Olivier juge intéressant/nécessaire la sous-section abordant la question de quand renommer
- La rédiger
**** TODO Papier : Intégrer corrections et remarques proposées par Olivier
- Olivier m'a fait part de ses remarques et m'a listé des corrections à effectuer
- Modifier le papier en conséquence
**** TODO Papier : Envoyer cette version complète à Olivier et Gérald
...
**** IN-PROGRESS CRDT : Lire *A higly-available move operation for replicated trees and distributed filesystems*

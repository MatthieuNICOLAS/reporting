...
**** IN-PROGRESS Spécifier les mesures à effectuer sur le temps d'intégration des opérations
...
**** IN-PROGRESS Faire la procédure d'inscription en 4ème année de doctorat
**** TODO Mettre à jour le pseudo-code de /renameId()/
**** TODO Écrire en pseudo-code /reverseRenameId()/
**** TODO Rédiger le plan détaillé du papier
...
- Spécifier les mesures à effectuer sur le temps d'intégration des opérations
  ...
  - Qu'est-ce que je peux ajouter comme nouvelles mesures ?
	...
	- Devrait ajouter un overhead correspondant à l'annulation du renommage courant
  ...
  - Comment obtenir ces mesures ?
    - Temps d'inté de renommages
      - Prendre une snapshot {3,6,9,12,15}0k opés avant renommage
	...
	- /nbOpes/
	- /type/ avec comme valeurs possibles "local", "remote", "winningConcurrent" et "losingConcurrent"
	- /time/
      ...
      - Peut boucler 3x histoire d'accroître le dataset
* Backlog
